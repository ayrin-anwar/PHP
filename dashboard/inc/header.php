    ...
    <img src="upload/<?php echo $_SESSION['profile_image'];?>" width="50" >
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="changepassword.php"><i class="icon ion-ios-folder-outline"></i>Change password</a></li>
                <li><a href="../logout-profile.php"><i class="icon ion-power"></i> Sign Out</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
