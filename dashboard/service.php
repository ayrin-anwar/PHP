...
<div class="container">
 <div class="row">
  ...
  <div class="text-right">
      <a href="add-service.php"><i class="fa fa-plus"></i>ADD</a>
...
foreach($querydata as $key=>$value){?>
 ...
 <tr>
        ...
        <td><?=++$key ?></td>
         <td><?=$value['name']?></td>
          <td> <?php $iconexplode=explode(' ',$value['icon']); ?><i class="<?php if($iconexplode[0]=="fab"){echo str_replace('fab','fa',$value['icon']);} if($iconexplode[0]=="fal"){echo str_replace('fal','fa',$value['icon']);} ?>"></i>
		  </td>
           <td><?=$value['summary']?></td>
             <td><?=$value['status']?></td>
        <td>
