 <?php
  require_once  "inc/header.php";
   ...
   $select="SELECT *FROM partners  WHERE status=1";
...
<div class="container">
 <div class="row">
  ...
  <h2 class="text-center">All Partners</h2>
  <div class="text-right">
      <a href="add-partners.php"
        ...
        <td><?=++$key ?></td>
         <td><?=$value['name']?></td>
          <td><?=$value['designation']?></td>
           <td><?=$value['message']?></td>
          <td><img src="<?="partners/".$value['photo']?>" height="150" width="150" ></td>
